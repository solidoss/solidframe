...
inline ResolveIterator::ResolveIterator()
    : paddr(NULL)
{
}
...
inline ResolveIterator::ResolveIterator(addrinfo* _pa)
    : paddr(_pa)
{
}
...
inline SocketAddressStub::SocketAddressStub(const SocketAddress& _rsa)
    : addr(_rsa.sockAddr())
    , sz(_rsa.size())
{
}
inline SocketAddressStub::SocketAddressStub(const SocketAddressInet& _rsa)
    : addr(_rsa.sockAddr())
    , sz(_rsa.size())
{
}
inline SocketAddressStub::SocketAddressStub(const SocketAddressInet4& _rsa)
    : addr(_rsa.sockAddr())
    , sz(_rsa.size())
{
}
inline SocketAddressStub::SocketAddressStub(const SocketAddressInet6& _rsa)
    : addr(_rsa.sockAddr())
    , sz(_rsa.size())
{
}
#ifndef SOLID_ON_WINDOWS
inline SocketAddressStub::SocketAddressStub(const SocketAddressLocal& _rsa)
    : addr(_rsa.sockAddr())
    , sz(_rsa.size())
{
}
...
{
    solid_assert_log(addr, generic_logger);
...
inline SocketAddress::SocketAddress(const SocketAddressStub& _rsas)
    : sz(0)
{
    clear();
...
inline SocketAddress::SocketAddress(const char* _addr, int _port)
    : sz(0)
{
    clear();
    address(_addr);
...
inline SocketAddress::SocketAddress(const char* _path)
    : sz(0)
{
    clear();
    path(_path);
    ...
    if (sockAddr()->sa_family == _raddr.sockAddr()->sa_family) {
        if (isInet6()) {
            return (memcmp(
                        ...
                        sizeof(in6_addr))
                       == 0)
                && (d.inaddr6.sin6_port == _raddr.d.inaddr6.sin6_port);
        }
...
inline SocketAddressInet::SocketAddressInet()
    : sz(0)
{
    clear();
}
inline SocketAddressInet::SocketAddressInet(const SocketAddressStub& _rsas)
    : sz(0)
{
    clear();
...
inline SocketAddressInet::SocketAddressInet(const char* _addr, int _port)
    : sz(0)
{
    clear();
    address(_addr);
