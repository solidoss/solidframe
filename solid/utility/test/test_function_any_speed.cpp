...
struct Event {
    ...
    using AnyT = std::any;
#else
    static constexpr size_t any_size = 1; // sizeof(void*) == 8 ? any_size_from_sizeof(64 - sizeof(void*) - sizeof(uintptr_t)) : any_size_from_sizeof(32 - sizeof(void*) - sizeof(uintptr_t));
