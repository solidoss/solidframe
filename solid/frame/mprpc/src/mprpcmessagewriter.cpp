    ...
    ErrorConditionT&     _rerror)
{
    ...
    while (
        ...
        case MessageStub::StateE::WriteStart: {
            ...
            solid_log(logger, Info, this << " message header relay: [" << rmsgstub.msgbundle_.message_relay_header_ << "] isRelay = " << rmsgstub.isRelay());
        ...
        case MessageStub::StateE::RelayedStart: {
            ...
            solid_log(logger, Verbose, this << " message header relay: " << rmsgstub.prelay_data_->pmessage_header_->relay_);
    ...
    ErrorConditionT&             _rerror)
{
    ...
    if (!rmsgstub.msgbundle_.message_relay_header_.empty()) {
        _rsender.context().message_flags.set(MessageFlagsE::Relayed);
    }
    _rsender.context().pmessage_relay_header_ = &rmsgstub.msgbundle_.message_relay_header_;
