...
const reflection::EnumMap figure_enum_map{TypeToType<FigureE>(), {
    {Zero, "Zero"}, {One, "One"}, {Two, "Two"}, {Three, "Three"}, {Four, "Four"}, {Five, "Five"},
    {Six, "Six"}, {Seven, "Seven"}, {Eight, "Eight"}, {Nine, "Nine"}
}};

const reflection::EnumMap user_status_map = {TypeToType<UserStatus>(), {
    {StatusMarriedE, "Married"},
    {StatusSingleE, "Single"},
    {StatusRelationE, "Relation"}
}};
...
struct Test{
    ...
    vector<User>    user_vec_ = {
        {
            "gigi", "1",  "gigi@gigi.com", 80, 180, StatusMarriedE, {"mimi", "bibi", "cici"},
        },
        {
            "vivi", "2",  "vivi@vivi.com", 60, 160, StatusSingleE, {"fifi", "lili", "sisi"},
        },
        {
            "zizi", "3",  "zizi@zizi.com", 70, 170, StatusRelationE, {"pipi", "titi", "qiqi"},
        }
    };
    struct Service{
        uint64_t id_;
