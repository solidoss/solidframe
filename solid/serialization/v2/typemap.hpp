...
template <typename TypeId, class Ctx, template <typename> class Ser, template <typename> class Des, class Data>
class TypeMap: protected TypeMapBase{
public:
    using ContextT = Ctx;
    using SerializerT = Ser<ContextT>;
    using DeserializerT = Des<ContextT>;
