...
$JAMEXE toolset=sun stdlib=sun-stlport instruction-set=i586 address-model=32 --with-filesystem --with-system --with-program_options --prefix="$EXT_DIR" --exec-prefix="$EXT_DIR" install
cd ../
